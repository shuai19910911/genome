...
def main() -> int:
    ...
    lines = [
        ...
        "## 外部注释补充",
        "",
        item("已将 98 个 Ensembl Plants 候选 GFF3/GTF 归档到本地 assembly 目录；本次扩大扫描到 31 个当前缺口物种、每物种最多 100 个目录。"),
        item("已归档: `Cucumis_melo_GCA_902497455.1`、`Citrullus_lanatus_GCA_000238415.2`、`Solanum_tuberosum_GCA_014189475.1`、`Malus_domestica_GCA_002114115.1`、14 个 `Oryza sativa` assembly、76 个 `Hordeum vulgare` assembly，以及 4 个 `Triticum aestivum` assembly。"),
        item("本次新增 4 个大麦候选: `GCA_951817375.1`、`GCA_951817435.1`、`GCA_949783235.1`、`GCA_949783195.1`，均已按 seqid/长度验证通过；当前 Hordeum vulgare Ensembl assembly-name 候选已清空。"),
        ...
        item("Ensembl Plants 候选扫描已扩展到当前 31 个缺口物种，发现 140 个同物种候选目录、60 个 assembly 名称候选；目前已有 98 个候选完成坐标验证和归档。"),
