...
|---|---|---|
| validation outcome 表 | `local_reports/2026-06-07-validation-outcome-table.tsv` | 121 条外部注释候选验证记录 |
...
| 分组 | 主要结果 |
|---|---|
| source_route | Ensembl Plants 99/106 通过；RefSeq paired 3/3 通过；Gramene 0/7；MaizeGDB 0/3；LegumeInfo 1/2 |
| species | Hordeum vulgare 76/76 通过；Oryza sativa 15/19；Triticum aestivum 4/10；Solanum lycopersicum 1/3；Zea mays 0/3 |
| assembly_level | Chromosome 99/107 通过；Complete Genome 3/3；Scaffold 1/9；Contig 0/2 |
