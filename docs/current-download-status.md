...
- 已将 46 个 Ensembl Plants 候选 GFF3/GTF 归档到本地 assembly 目录，其中本次检查新增 1 个水稻和 3 个小麦候选。
- 已归档: `Cucumis_melo_GCA_902497455.1`、`Citrullus_lanatus_GCA_000238415.2`、`Solanum_tuberosum_GCA_014189475.1`、`Malus_domestica_GCA_002114115.1`、14 个 `Oryza sativa` assembly、24 个 `Hordeum vulgare` assembly，以及 4 个 `Triticum aestivum` assembly。
...
- Ensembl Plants 候选扫描覆盖失败最多的前 12 个物种，发现 70 个同物种候选目录；目前已有 46 个候选完成坐标验证和归档。
