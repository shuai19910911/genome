...
- 更新时间: 2026-06-07 19:51:48
- 完成记录数: 149
- 失败记录数: 1755
- 已生成 assembly 目录数: 1906
- 已生成 README 的完成目录数: 233
- 本地数据总量: 903365117479 bytes (841.32 GiB)
- 下载管理进程数: 0
- aria2 活动下载数: 0
- 最近速度: 0.00 MiB/s
...
- 有 genome 和至少一种注释的目录: 238
- 只有 genome、缺少 GFF3/GTF 注释的目录: 1668
- 完整索引: `docs/completed-genome-index.tsv`
- 未完整索引: `docs/incomplete-genome-index.tsv`

## 外部注释补充

- 已将 78 个 Ensembl Plants 候选 GFF3/GTF 归档到本地 assembly 目录；本次扩大扫描到 31 个当前缺口物种、每物种最多 100 个目录。
- 已归档: `Cucumis_melo_GCA_902497455.1`、`Citrullus_lanatus_GCA_000238415.2`、`Solanum_tuberosum_GCA_014189475.1`、`Malus_domestica_GCA_002114115.1`、14 个 `Oryza sativa` assembly、56 个 `Hordeum vulgare` assembly，以及 4 个 `Triticum aestivum` assembly。
- 本次新增 8 个大麦 HOR 候选: `GCA_949783415.1`、`GCA_949783475.1`、`GCA_949783345.1`、`GCA_949783425.1`、`GCA_949783315.1`、`GCA_949783325.1`、`GCA_949783575.1`、`GCA_951815805.1`，均已按 seqid/长度验证通过。
- 最近六批新增的 46 个大麦候选的 Ensembl GTF metadata accession/genome-version 与本地 assembly 一致，并已按染色体/contig 别名和长度验证通过。
...
- Ensembl Plants 候选扫描已扩展到当前 31 个缺口物种，发现 140 个同物种候选目录、60 个 assembly 名称候选；目前已有 78 个候选完成坐标验证和归档。
